...
(function()
{
    ...
    function displayHome()
    {
      ...
      //document.querySelector("body").style.background = "url(../Assets/finn.png)";
        ...
        homeParagraph.textContent = "This is the home page of the site that we will be building over the course of our semester in WEBD 6201.<br/>With Tom Tsilliopolous";
